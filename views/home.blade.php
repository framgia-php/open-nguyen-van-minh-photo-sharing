...
@parent
    ...
    @for($i = 0; $i < round(count($images)/2); $i++)
        ...
        <div class="text-left user">
            <span class="tieude">
                <a href="{{ 'userpage/' . $images[$i]['id']}}">
                    <img src="{{ url('/') . '/images/' . $images[$i]['avatar_photo'] }}" class="img-circle" alt="Cinque Terre" width="40" height="40"/>
                    {{$images[$i]['name'] }}
                </a>
                <br>
            </span>
            ...
            <br/>
             @endif
            <!-- Nơi hiển thị comment của người dùng -->
